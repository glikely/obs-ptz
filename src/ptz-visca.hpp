 ...
 * lives here. Which concrete transport is instantiated is selected at
 * runtime (see PTZVisca::setInterface()), which is what lets a single
 * PTZVisca object represent a serial, UDP, or TCP connected camera.
 */
